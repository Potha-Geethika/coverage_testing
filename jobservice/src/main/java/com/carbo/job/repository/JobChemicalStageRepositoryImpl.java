...
@Slf4j
public class JobChemicalStageRepositoryImpl implements JobChemicalStageRepository {
    ...
    @Override
    public void updateInProgressChemicalStage(String jobId, String wellId,
                                                  ChemicalStageNoIndex stageDto,
                                                  String modifiedBy, String organizationId) {
        ...
        ChemicalStageNoIndex stageMap = objectMapper.convertValue(stageDto, ChemicalStageNoIndex.class);
        
        // Update the inProgressChemicalStage for the specific well
        update.set("wells.$.inProgressChemicalStage", stageMap);
        ...
        log.info("Updated inProgressChemicalStage for job: {}, well: {}, matched: {}, modified: {}", 
