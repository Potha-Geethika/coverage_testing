...
class JobDashboardServiceTest {
    ...
    void getPadDetails_HappyPath() {
        ...
        when(mongoTemplate.find(any(), eq(ActivityLogEntry.class), anyString())).thenReturn(activityLogs);

        ResponseEntity<?> response = jobDashboardService.getPadDetails(request, "jobId1");
    ...
    void getPadDetails_UnexpectedError() {
        when(jobMongoDbRepository.findByIdAndSharedWithOrganizationId(any(), any())).thenThrow(new RuntimeException("Error"));
    ...
    @Test
    void calculatePadDurationDays_HappyPath() {
        double duration = jobDashboardService.calculatePadDurationDays(job, activityLogs, "UTC");
        assertEquals(0.01, duration);
    }

    @Test
    void calculatePadDurationDays_JobNull() {
        double duration = jobDashboardService.calculatePadDurationDays(null, activityLogs, "UTC");
        assertEquals(0.01, duration);
    }

    @Test
    void calculatePadDurationDays_JobStartDateNull() {
    ...
    void getWellCompletionInformation_HappyPath() {
        ...
        ResponseEntity<?> response = jobDashboardService.getWellCompletionInformation(request, "jobId1", "wellId1");
    ...
    void getCleanPerStage_HappyPath() {
        ...
        ResponseEntity<?> response = jobDashboardService.getCleanPerStage(request, "jobId1", "wellId1");
    ...
    void getAveragePressureAndRate_HappyPath() {
        ...
        ResponseEntity<?> response = jobDashboardService.getAveragePressureAndRate(request, "jobId1", "wellId1");
    ...
    void getFinalISIPAndFG_HappyPath() {
        ...
        ResponseEntity<?> response = jobDashboardService.getFinalISIPAndFG(request, "jobId1", "wellId1");
    ...
    void getAverageVsMax_HappyPath() {
        ...
        ResponseEntity<?> response = jobDashboardService.getAverageVsMax(request, "jobId1", "wellId1");
